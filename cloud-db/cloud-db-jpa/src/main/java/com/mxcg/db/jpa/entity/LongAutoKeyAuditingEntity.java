...
@Getter
@Setter
public abstract class LongAutoKeyAuditingEntity extends AuditingEntity implements KeyValueExportable, AutoKey, HasPkey<Long>
{
    /**
     * 注释内容
     */
    ...
    public boolean equals(Object obj)
    {
        ...
        LongAutoKeyAuditingEntity other = (LongAutoKeyAuditingEntity)obj;
        if (pkey == null)
        {
